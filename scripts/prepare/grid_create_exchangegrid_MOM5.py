...
def grid_create_exchangegrid_MOM5(input_dir,        # root directory of IOW ESM
    ...
    intersection_grid_file      = input_dir+'/'+bottom_model+'/mappings/'+which_grid+'_intersectiongrid.nc'
    ...
    exchange_grid_type = "intersection"
    #exchange_grid_type = "atmos"                                                                
    #exchange_grid_type = "bottom"
